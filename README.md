...
Writen with [esp-adf-v2.4](https://github.com/espressif/esp-adf/releases/tag/v2.4) 
Follow expressif documentation for installation [here](https://docs.espressif.com/projects/esp-adf/en/latest/get-started/index.html#linux-and-macos)
